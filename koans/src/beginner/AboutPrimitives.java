...
public class AboutPrimitives {
    ...
    public void shortsHaveASmallerRangeThanInts() {
        assertEquals((int) Short.MIN_VALUE,  -32768);  // hint: You'll need an explicit cast
        assertEquals((int)Short.MAX_VALUE, 32767);
    }
    ...
    public void bytesHaveASmallerRangeThanShorts() {
        assertEquals((int) Byte.MIN_VALUE, -128);
        assertEquals((int) Byte.MAX_VALUE, 127);
